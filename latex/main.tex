...
An Inferential Study of Carrier, Seasonal, and Geographic\\[4pt]
Drivers of Arrival Delays in 2024\par}
...
\textbf{James Czeranko}        & \textbf{Ryan Garcia}          & \textbf{Yaksh Maulesh Pancholi}\\
Arizona State University       & Arizona State University      & Arizona State University\\
\texttt{jczerank@asu.edu}      & \texttt{rgarc234@asu.edu}     & \texttt{ypancho1@asu.edu}\\
\end{tabular*}
...
is fully reproducible: all code, data, and figures sit in the project's
GitHub repository, organized into four sequential scripts
